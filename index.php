            ...
            <div id="navbar" class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active any"><a href="#main-slider"><i class="fa fa-home fa-lg"></i></a></li>
                        <li class="any"><a href="#Cursos">Cursos</a></li>
                        <li><a href="cadastro.html">Cadastre-se</a></li>
                        <li class="any"><a href="#contact">Contato</a></li>
                    </ul>
        ...
        <div class="container">
            <div class="box second">
                ...
                <ul class="portfolio-filter">
                    ...
                    <li><a class="btn btn-primary" href="#" data-filter=".mec">Mecânica</a></li>
                    ...
                    <li><a class="btn btn-primary" href="#" data-filter=".lang">Idiomas</a></li>
                    <li><a class="btn btn-primary" href="#" data-filter=".ext">Exatas</a></li>
                ...
                <?php
                    $sql = mysqli_query($conexao,"SELECT id,nome,link,descricao,categoria,page FROM cad_cursos LIMIT 3 ");
                    ...
                    <div class="col-sm-6">
                        ...
                        <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="sendemail.php" role="form">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea name="message" id="message" required class="form-control" rows="8" placeholder="Menssagem"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-danger btn-lg " value="">Enviar</button>
                                    </div>
                                </div>
                            </div>
                        </form>
