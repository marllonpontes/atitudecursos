...
<?php
 $sql = mysqli_query($conexao,"SELECT id,curso,link,nota,code,img FROM cursos ");
?>
    ...
    <li class="portfolio-item apps">
        <div class="item-inner">
            ...
            <div id="caixa" class="blank"><h4><?=$valor["curso"]?></h4>
                ...
                <h5><i class="fa fa-check-square-o"></i> Nota: <?=$valor["nota"]?>.0</h5><?php echo "<a href=\"delete.php?id=$id\"><button id='trash' class='btn btn-default pull-right per-max'><i class='fa fa-trash-o'></i></button></a>"; ?>
